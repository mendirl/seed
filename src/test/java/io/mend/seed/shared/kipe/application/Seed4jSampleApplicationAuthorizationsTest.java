...
import static io.mend.seed.shared.kipe.domain.RolesAccessesFixture.*;
...
import io.mend.seed.shared.authentication.application.UnknownAuthenticationException;
import io.mend.seed.shared.authentication.domain.Username;
import io.mend.seed.shared.error.domain.MissingMandatoryValueException;

@UnitTest
class Seed4jSampleApplicationAuthorizationsTest {

  private static final Seed4jSampleApplicationAuthorizations authorizations = new Seed4jSampleApplicationAuthorizations(
